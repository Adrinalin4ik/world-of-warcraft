...
THREE.Float32BufferAttribute.prototype['copyVector3sArray'] = function ( vectors ) {
...
THREE.Float32BufferAttribute.prototype['copyVector4sArray'] = function ( vectors ) {
...
export class Geometry extends THREE.EventDispatcher {
	...
	fromBufferGeometry( geometry ) {
		...
		function addFace( a, b, c, materialIndex = 0 ) {
	...
	toBufferGeometry() {
		...
		// // create a Float32Array to hold the vertex colors
		// const colors = new Float32Array(geometry.vertices.length * 3);

		// // loop through each vertex and store its position and color in the arrays
		// for (let i = 0; i < geometry.vertices.length; i++) {
		// 	positions[i * 3] = geometry.vertices[i].x;
		// 	positions[i * 3 + 1] = geometry.vertices[i].y;
		// 	positions[i * 3 + 2] = geometry.vertices[i].z;
			
		// 	const color = geometry.colors[i];
		// 	if (color) {
		// 		colors[i * 3] = color.r;
		...
		// // set the color attribute on the buffer geometry
